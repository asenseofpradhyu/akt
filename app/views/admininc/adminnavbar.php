                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown dropdown-user admin-user">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo URLROOT; ?>/adminmaster/logoutAdmin"><i class="fa fa-sign-out"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel">
                <div class="image pull-left">
                    <img src="<?php echo URLROOT; ?>/admin/dist/img/avatar5.png" class="img-circle" alt="User Image">
                </div>
                <div class="info">
                    <h4>Welcome</h4>
                    <p>Mr. Alrazy</p>
            ...
            <ul class="sidebar-menu">
                <li class="active">
                    <a href="<?php echo URLROOT; ?>/adminmaster/admindashboard"><i class="fa fa-hospital-o"></i><span>Dashboard</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-bars"></i><span>Add Navigation</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo URLROOT; ?>/navigation/mainnavigation">Main Navigation</a></li>
                        <li><a href="<?php echo URLROOT; ?>/navigation/subnavigation">Sub Navigation</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo URLROOT; ?>/homepage/mainslider">MainSlider</a></li>
                        <li><a href="<?php echo URLROOT; ?>/homepage/gridimages">Grid Images</a></li>
                        <li><a href="<?php echo URLROOT; ?>/homepage/salescollection">Sales Collection</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-sitemap"></i><span>Product</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo URLROOT; ?>/adminProduct/addproduct">Add Product Details</a></li>
                        <li><a href="<?php echo URLROOT; ?>/adminProduct/addproductimages">Add Product Images</a></li>
                        <li><a href="<?php echo URLROOT; ?>/adminProduct/color">Add Color</a></li>
                        <li><a href="<?php echo URLROOT; ?>/adminProduct/adminproductlist">Product List</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-sitemap"></i><span>Coupons</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo URLROOT; ?>/coupon/addCoupons">Add Coupons</a></li>
                        <!-- <li><a href="<?php echo URLROOT; ?>/adminproduct/addproductimages">Add Product Images</a></li> -->
                        <!-- <li><a href="<?php echo URLROOT; ?>/adminproduct/color">Add Color</a></li> -->
