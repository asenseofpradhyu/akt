                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Select Main Navigation</label>
                                                <select class="form-control" id="" name="mainNavSelect" size="1">
                                                    ...
                                                    <option value="<?php echo $nav->main_menu_id?>"
                                                    <?php if ($data['mainnav'] == $nav->main_menu_id) {
                                                                                                echo "selected";
                                                                                            } ?>
                                        ...
                                        <div class="col-sm-6 form-group">
                                                ...
                                                <select class="form-control" id="" name="subNavSelect" size="1">
                                                    ...
                                                    <option value="<?php echo $nav->sub_menu_id?>"
                                                    <?php if ($data['subnav'] == $nav->sub_menu_id) {
                                                                                                echo "selected";
                                                                                            } ?>
                                             ...
                                             <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" value="<?php echo $data['productname']; ?>" placeholder="Enter Product Name">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['productname_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Product Description</label>
                                                <textarea name="description" class="form-control" placeholder="Product Description" rows="1"><?php echo $data['productdesc']; ?></textarea>
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['productdesc_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Total Price</label>
                                                <input type="text" class="form-control" name="totalprice" value="<?php echo $data['totalprice']; ?>" placeholder="Enter Total Price">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['totalprice_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Discount Price</label>
                                                <input type="text" class="form-control" name="discountprice" value="<?php echo $data['discountprice']; ?>" placeholder="Enter Discount Price">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['discountprice_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Product Code</label>
                                                <input type="text" class="form-control" name="code" value="<?php echo $data['code']; ?>" placeholder="Enter Product Code">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['code_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Stock</label>
                                                <input type="text" class="form-control" name="stock" value="<?php echo $data['stock']; ?>" placeholder="Enter Total Stock">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="length" value="<?php echo $data['length']; ?>" placeholder="Enter Feature Length">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['length_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Feature Garment Type</label>
                                                <input type="text" class="form-control" name="garment" value="<?php echo $data['garment']; ?>" placeholder="Enter Garment Type">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['garment_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Feature Neck</label>
                                                <input type="text" class="form-control" name="neck" value="<?php echo $data['neck']; ?>" placeholder="Enter Neck">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['neck_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Feature Fabric</label>
                                                <input type="text" class="form-control" name="fabric" value="<?php echo $data['fabric']; ?>" placeholder="Enter Fabric">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['fabric_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Feature Occassion</label>
                                                <input type="text" class="form-control" name="occasion" value="<?php echo $data['occasion']; ?>" placeholder="Enter Occasion">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['occasion_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Feature Design Type</label>
                                                <input type="text" class="form-control" name="design" value="<?php echo $data['design']; ?>" placeholder="Enter Design Type">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="inclusive" value="<?php echo $data['inclusive']; ?>" placeholder="The Product Price is inclusive of">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="notinclusive" value="<?php echo $data['notinclusive']; ?>" placeholder="The Product Price is not Inclusive of:">
                                                <span class="invalid-feedback" style="color: red;"><?php echo $data['notinclusive_err']; ?></span>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>(Details)Care:</label>
                                                <input type="text" class="form-control" name="care" value="<?php echo $data['care']; ?>" placeholder="Care">
