                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data['gridimagelist'] as $nav) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $nav->acc_name; ?></td>
                                                <td><img src="<?php echo $nav->acc_img; ?>" alt="" style="width:200px; height:200px;"></td>
                                                <td><?php echo $nav->sub_menu_name; ?></td>
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo URLROOT; ?>/homepage/editaccessories/<?php echo $nav->indexacc_id; ?>" style="margin-right:10px;"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
                                                    <form style="display:inline-block;" action="<?php echo URLROOT; ?>/homepage/deleteaccessories/<?php echo $nav->indexacc_id; ?>" method="post">
