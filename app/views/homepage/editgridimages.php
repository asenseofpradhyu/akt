                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form action="<?php echo URLROOT; ?>/homepage/editgridimages/<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data" class="col-sm-12" id="editGridImages" name="editGridImages" novalidate>
