                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form action="<?php echo URLROOT; ?>/homepage/editsalescollection/<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data" class="col-sm-12" id="editSalesCollection" name="editSalesCollection" novalidate>
        ...
        $('#editSalesCollection').validate({
            ...
            messages: {
                ...
                subNavSelect: {
                    ...
                    maxlength: "Sub navigation must be at least 50 characters long"
                },
                gridimg: {
                    required: "Please select a grid image",
                    minlength: "Grid image must be at least 1 characters long",
                    maxlength: "Grid image must be at least 50 characters long"
                }
            }
        });
    });
