            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo URLROOT; ?>/homepage/salescollection" method="post" enctype="multipart/form-data" class="col-sm-12">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data['gridimagelist'] as $nav) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $nav->sc_name; ?></td>
                                                <td><img src="<?php echo $nav->sc_img; ?>" alt="" style="width:200px; height:200px;"></td>
                                                <td><?php echo $nav->sub_menu_name; ?></td>
                                                <td>
                                                    <a class="btn btn-primary" href="<?php echo URLROOT; ?>/homepage/editsalescollection/<?php echo $nav->indexsc_id; ?>" style="margin-right:10px;"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
                                                    <form style="display:inline-block;" action="<?php echo URLROOT; ?>/homepage/deletesalescollection/<?php echo $nav->indexsc_id; ?>" method="post">
