            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo URLROOT; ?>/navigation/editmainnavigation/<?php echo $data['id']; ?>" method="post" class="col-sm-12" id="EditMainNavigation" name="EditMainNavigation">
